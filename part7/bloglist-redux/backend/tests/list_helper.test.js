...
describe('total likes', () => {
	...
	test('sum likes of all of the blogs', () => {
...
describe('most liked', () => {
	test('return string "there is no favorite blog here" when array.length === 0', () => {
		...
		expect(result).toBe('there is no favorite blog here')
	})

	test('if arr of blogs has 1 element return object with this blog data', () => {
	...
	test('return object with data of blog which has most of the likes', () => {
