...
const OccupationalHealthcareForm = ({
	...
	const [description, setDescription] =
		useState<OccupationalHealthcareEntry['description']>('');
	const [date, setDate] = useState<OccupationalHealthcareEntry['date']>('');
	const [specialist, setSpecialist] =
		useState<OccupationalHealthcareEntry['specialist']>('');
